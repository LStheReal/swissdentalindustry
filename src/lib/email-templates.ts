...
const FIELD_LABELS: Record<string, string> = {
  ...
  contact_job_title: "Kontakt · Funktion",
  contact_email: "Kontakt · E-Mail",
  contact_phone: "Kontakt · Telefon",
  contact_street_name: "Kontakt · Strasse",
  contact_street_number: "Kontakt · Hausnummer",
  contact_postal_code: "Kontakt · PLZ",
  contact_city: "Kontakt · Ort",
  contact_address_same: "Kontakt · Adresse = Firmenadresse",
  subject: "Betreff",
  source: "Quelle",
  logo_url: "Logo",
};
